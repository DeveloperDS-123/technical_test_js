...
export function Nav({ links, isCollapsed }: NavProps) {
  ...
  const isActiveLink = (linkHref: string) => {
    if (linkHref.includes('recommendation')) {
      return pathName.includes('recommendation');
    }
            ...
            isCollapsed ? (
              ...
              <Link
                ...
                className={cn(
                  ...
                  "justify-start w-full min-w-[200px] flex items-center"
                )}
              >
                ...
                {link.label && (
                  <span
                    className={cn(
                      "ml-2 text-sm truncate shrink-0",
                      link.variant === "default" &&
